...
public class TC_02_Deny_Cookies extends BasePage{
	
	public TC_02_Deny_Cookies() throws IOException {
		super();
...
public ExtentTest log;
	...
	@Test(priority=1)
	public void TC_02_Login_Deny_Cookies() throws IOException, InterruptedException {
		
		log = report.startTest("TC_02_Deny_Cookies");
		...
		log.log(LogStatus.PASS, "Clicked on Deny Cookies");
		...
		try {
			Assert.assertEquals(Expected, Actual);
			log.log(LogStatus.PASS, "Logged out successfully & Navigated to Workbench URL");
	    } catch (AssertionError e) {
